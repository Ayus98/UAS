...
Route::group(['prefix' => 'karyawan'], function() {
    ...
    Route::get('/new', 'KaryawanController@create');
    Route::post('/', 'KaryawanController@save');
    Route::get('/{id}', 'KaryawanController@edit');
    Route::put('/{id}', 'KaryawanController@update');
    Route::delete('/{id}', 'KaryawanController@destroy');
});
